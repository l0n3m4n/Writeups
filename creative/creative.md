...
> found a URL checker submit form that can send a request to my own IP as you can see below image we get a callback, which could indicate potential vulnerabilities in the application.
