...
== Changelog ==
= 1.07 =
fix extremely stupid svn error where needed files from the j2s directory were not in the repo
= 1.06 =
change rcsb file path to avoid redirect
= 1.05 =
load rcsb pdb files via https instead of http
= 1.04 =
...
** Added set language directive based on wordpress get_locale()
= 1.03 =
* updated jsmol package from Jmol sourceforge
